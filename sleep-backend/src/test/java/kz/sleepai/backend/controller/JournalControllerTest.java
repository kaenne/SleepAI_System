...
class JournalControllerTest {
    ...
    void getEntries_ShouldReturnAllEntries() throws Exception {
        ...
        org.springframework.data.domain.Page<JournalEntry> page =
                new org.springframework.data.domain.PageImpl<>(entries);
        when(journalService.getAllEntries(
