...
import kz.sleepai.backend.dto.LoginRequest;
import kz.sleepai.backend.dto.RegisterRequest;
...
class AuthControllerTest {
    ...
    void register_ShouldReturnOkWithTokens() throws Exception {
        ...
        when(authenticationManager.authenticate(any(UsernamePasswordAuthenticationToken.class)))
                .thenReturn(mockAuth);
        when(jwtCore.generateToken(anyString(), anyLong())).thenReturn("access-token");
        when(jwtCore.generateRefreshToken(anyString(), anyLong())).thenReturn("refresh-token");
