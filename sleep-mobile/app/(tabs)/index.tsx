...
export default function HomeScreen() {
  ...
  const handlePredictSleep = async () => {
    ...
    try {
      ...
      console.error(error);
      setAiPrediction({ quality: 0, message: "Ошибка анализа" });
    } finally {
              ...
              <View style={styles.headerBadgeContainer}>
                <BlurView intensity={20} tint={colorScheme === 'dark' ? 'dark' : 'light'} style={styles.glassBadge}>
                  ...
                  <ThemedText style={styles.statusText}>
                    {backendStatus.isOnline ? " Онлайн" : "Оффлайн"}
                  </ThemedText>
                </BlurView>
              </View>
            </Animated.View>
          ...
          <Animated.View entering={FadeInUp.delay(50).springify()}>
            <BlurView intensity={colorScheme === 'dark' ? 40 : 80} tint={colorScheme === 'dark' ? 'dark' : 'light'} style={styles.glassActionsRow}>
              <Pressable onPress={() => router.push("/(tabs)/stats")} style={styles.glassActionBtn}>
                ...
                <ThemedText type="caption" style={styles.actionText}>Статистика</ThemedText>
              </Pressable>
              ...
              <Pressable onPress={() => router.push("/modal")} style={styles.glassActionBtn}>
                ...
                <ThemedText type="caption" style={styles.actionText}>Дневник</ThemedText>
              </Pressable>
              ...
              <Pressable onPress={() => setShowAddEntry((v) => !v)} style={styles.glassActionBtn}>
                ...
                <ThemedText type="caption" style={styles.actionText}>Добавить</ThemedText>
              </Pressable>
            </BlurView>
          </Animated.View>
            ...
            <Animated.View entering={FadeIn.duration(300)}>
              <Card variant="elevated" style={styles.premiumCard}>
                <View style={styles.cardHeaderRow}>
                  ...
                  <ThemedText type="subtitle" style={{flex:1}}>Запись сна</ThemedText>
                </View>
                
                <View style={styles.inputRow}>
                  <View style={styles.inputField}>
                    <ThemedText type="caption" style={styles.inputLabel}>���� ���</ThemedText>
                  ...
                  <View style={styles.inputField}>
                    <ThemedText type="caption" style={styles.inputLabel}>������ (1-10)</ThemedText>
                    <View style={[styles.inputContainer, { backgroundColor: colors.inputBackground, borderColor: colors.inputBorder }]}>
                      <TextInput
                ...
                <View style={styles.buttonRow}>
                  <View style={{flex:1}}>
                    <Button title="���������" onPress={onSave} variant="primary" />
                  </View>
                  <View style={{flex:1}}>
                    <Button 
                      title={isPredicting ? "�����..." : "AI �����"} 
          ...
          <Animated.View entering={FadeInUp.delay(200).springify()} style={styles.statsRow}>
            ...
            >
              ...
              <View style={styles.badgeRow}>
                <Badge label={sleepQuality === 'well-rested' ? 'Хорошо' : 'Плохо'} variant={sleepQuality === 'well-rested' ? 'success' : 'warning'} size="sm" animated={false} />
